...
// useEffect and useToast were used by GmailOAuthHandler (now commented out)
...
// GmailOAuthHandler commented out — Gmail OAuth is not used; app uses Replit Auth + Resend.
